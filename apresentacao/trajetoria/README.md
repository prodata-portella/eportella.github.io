...
Nasci em 24/06/2016 e fui constituida por **Ewerton da Silva Portella**, mas antes de falar da [minha trajetória](#minha-trajetória) vou vamos passar pela [trajetória dele](#trajetória-do-ewerton-da-silva-portella).
...
- Hoje eu estou no meu <span id="portella-age">`tempo atual`</span>º ano.

>[!TIP]
>
>- Minha trajetória está em constrante contrução. Sempre que tver algo novo para contar, tão breve deixaei disponível.

Uma tragetória de <span id="age-total">`idade total`</span> anos sendo <span id="age-contato">`idade contato`</span> desde o primeiro contato e <span id="age-experiencia">`idade experiência`</span> anos de experiência.
